...
let WEATHER_API_KEY=process.env.NEXT_PUBLIC_WEATHER_APP_KEY
...
export default function Home() {
  ...
  const getWeatherData= async()=>{
    //https://api.openweathermap.org/data/2.5/weather?q=hyderabad&appid=e5a3ad0d2a745b64015ba53cc3da07ad

    if (place && place.length > 0) {
      try{
        let url =`https://api.openweathermap.org/data/2.5/weather?q=${place}&appid=e5a3ad0d2a745b64015ba53cc3da07ad`
